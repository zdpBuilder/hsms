		        ...
		        <div class="my-btn-box" style="margin-bottom:-10px;">
		            ...
		            <div class="fr" >
		                ...
		                <div class="layui-input-inline">
		                    <input type="text" autocomplete="off" id="keywords" name="keywords" placeholder="姓名" class="layui-input " style="height:26px;font-size:12px;"/>
		                </div> 
			    ...
			    if(data.length>0){
			    	...
			    	layer.confirm('确认删除 '+data.length+' 条信息？', {
		      	    	  ...
		      	    	  btn: ['确认','取消'] //按钮
		      	    		...
		      	    		$.ajax({
		        	  			method: "post",
		        	  			url:"${pageContext.request.contextPath}/supplier/deleteBatch",
		        	  			data:{"idStr":idStr},
	      	 ...
	      	 table.on('tool(tableFilter)', function(obj){
	      	    ...
	      	    if(obj.event === 'del'){
	      	      ...
	      	      layer.open({
	        		  ...
	        		  ,maxmin: false //开启最大化最小化按钮
	        		  ,anim: 5 //0-6的动画形式，-1不开启
	        		  ,content: 'supplierInfo.jsp?id='+data.id
	        	   });
