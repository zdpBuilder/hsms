...
<script type="text/javascript" src="../plugins/layui2.x/layui.js"></script>	
	...
	function reloadTable(pageNum){
		//刷新表格内容
		table.reload('braAgnTypListTable', {
		  page: {
		    curr: pageNum //当前页开始
		  } 
		});
	    ...
	    layui.use(['table', 'layer'], function () {
	        ...
	        table.render({
	        	...
	        	,url:'${pageContext.request.contextPath}/braagntyp/list'
	        	,id: 'braAgnTypListTable'
	        	,where: {
	        ...
	        /*   if(obj.checked == true){
	      	...
	      	$("#btn-add").click(function(){
	      		layer.open({
	      		  ...
	      		  ,content: 'braAgnTypInfo.jsp?roleStatus='+<%=roleStatus%>
	      	   });
	      	});
	      	//批量删除
			$("#btn-delete-all").click(function(){
				
				var checkStatus = table.checkStatus('braAgnTypListTable')
			    ...
			    if(data.length>0){
			    	...
			    	layer.confirm('确认删除 '+data.length+' 条用户信息？', {
		      	    	  ...
		      	    	  btn: ['确认','取消'] //按钮
		      	    		...
		      	    		$.ajax({
		        	  			method: "post",
		        	  			url:"${pageContext.request.contextPath}/braagntyp/deleteBatch",
		        	  			data:{"idStr":idStr},
	      	 ...
	      	 table.on('tool(tableFilter)', function(obj){
	      	    ...
	      	    if(obj.event === 'del'){
	      	      ...
	      	      layer.open({
	        		  ...
	        		  ,maxmin: false //开启最大化最小化按钮
	        		  ,anim: 5 //0-6的动画形式，-1不开启
	        		  ,content: 'braAgnTypInfo.jsp?id='+data.id+"&roleStatus="+<%=roleStatus%>
	        	   });
