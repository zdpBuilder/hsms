...
<form class="layui-form" action="">
   ...
   <div class="layui-form-item" style="margin-bottom:0px;">
            ...
            <div class="layui-input-inline">
                <input  id="userName" disabled  class="layui-input" style="width:160px;background-color:#F2F2F2;">
            </div>
        </div>
   <div class="layui-form-item" style="margin-bottom:0px;">
        ...
        <div class="layui-form-item" style="font-size:12px;line-height:10px;">
            ...
            <div class="layui-input-inline">
                <input id="newPassSecond" type="password" name="loginPassword" value="" placeholder="确认新密码" lay-verify="required|password" class="layui-input pwd" style="width:160px;">
            </div>
        </div> 
