		        ...
		        <div class="my-btn-box" style="margin-bottom:-10px;">
		            ...
		            <div class="fr" >
		                ...
		                <div class="layui-input-inline">
		                    <input type="text" autocomplete="off" id="keywords" name="keywords" placeholder="品牌名称" class="layui-input " style="height:26px;font-size:12px;"/>
		                </div> 
	...
	function reloadTable(pageNum){
	    ...
	    layui.use(['table', 'layer'], function () {
	        ...
	        table.render({
	        	...
	        	,url:'${pageContext.request.contextPath}/brand/list'
	        	,id: 'brandListTable'
	        	,where: {
	        ...
	        /*   if(obj.checked == true){
	      	...
	      	$("#btn-add").click(function(){
	      		layer.open({
	      		  ...
	      		  ,content: 'brandInfo.jsp'
	      	   });
	      	});
	      	//批量删除
			$("#btn-delete-all").click(function(){
				
				var checkStatus = table.checkStatus('brandListTable')
			    ...
			    if(data.length>0){
			    	...
			    	layer.confirm('确认删除 '+data.length+' 条品牌信息？', {
		      	    	  title: "确认消息", //标题
		      	    	  btn: ['确认','取消'] //按钮
		      	    	}, function(){
		      	    		//单条删除
